...
export class Slide {
    constructor(slide, wrapper) {
        ...
        this.dist = { finalPositon: 0, starX: 0, movement: 0 };
    ...
    onMove(event) {
        const pointerPositon =
            event.type === "mousemove"
                ? event.clientX
                : event.changedTouches[0].clientX;
        const finalPositon = this.updatePositon(pointerPositon);
    ...
    bindEvents() {
        ...
        this.activePreSlide = this.activePreSlide.bind(this);
...
export default class SlideNav extends Slide {
    ...
    addArrowEvent() {
        this.prevElement.addEventListener("click", this.activePreSlide);
